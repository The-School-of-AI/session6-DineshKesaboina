...
# poker function definition

def poker(card_set1, card_set2):
    ...
    # four of a kind
    elif four_of_kind(card_set1) ^ four_of_kind(card_set2):
    ...
    # full_house
    elif full_house(card_set1) ^ full_house(card_set2):
        if full_house(card_set1):
            return 'player1'
        else:
            return 'player2'

    elif full_house(card_set1) and full_house(card_set2):
    ...
    # two pair
    elif two_pair(card_set1) ^ two_pair(card_set2):
...
# four card game function definition

def four_card(card_set1, card_set2):
    """This function executes the four card mode. All poker hierachies except full house are implemented.
...
# three card game function definition

def three_card(card_set1, card_set2):
    """This function executes the three card mode. All poker hierachies except full house are implemented.
